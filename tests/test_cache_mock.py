"""Test cache with mock LLM (no API needed)"""
...
# Mock LLM first
import backends.llm_backend_mock as llm_backend_mock
sys.modules['backends.llm_backend'] = llm_backend_mock
...
try:
    ...
    print("✅ RAG data seeded (using MOCK LLM - no API needed)\n")
